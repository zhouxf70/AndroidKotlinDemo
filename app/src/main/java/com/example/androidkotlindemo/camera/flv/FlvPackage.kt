package com.example.androidkotlindemo.camera.flv
...
//        KLog.d("data len $dataLength : ${byteArray[1]}, ${byteArray[2]}, ${byteArray[3]}")
        // 4~6[7] : timeStamp
...
//        KLog.d("previous tag len $len : ${byteArray[0]}, ${byteArray[1]}, ${byteArray[2]}, ${byteArray[3]}")
        return byteArray
    }
